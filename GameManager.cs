...
public class GameManager : MonoBehaviour {
    ...
    public class CameraPos
    {
        ...
        public Vector3 midPos = new Vector3(-16, 0, -500);
    ...
    public CameraPos camPosition = new CameraPos();
    Camera camara;
    ...
    public IEnumerator MostrarJugador(Player playerP, int visorN, Vector3 visorPosition, bool flip)
    {
        ...
        DummysManager.Instance.DummyVisibility(true);
        yield return null;
    ...
    {
        Debug.LogError("Ha ocurrido un error");
    }
