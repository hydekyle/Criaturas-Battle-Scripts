...
namespace Enums {
    ...
    public enum Candy { Red, Yellow, Blue, Green, Purple, None };
    public enum EquipD_Type { Helmet, Armor, Back, Weapon1H, Weapon2H, Shield};
}
...
[Serializable]
public struct StatsD
{
    public int str, vit, dex, luck;
}

[Serializable]
public struct EquipD
{
    public EquipD_Type type;
...
public class Dummy
{
    public EquipD helmet, armor, back, hand_left, hand_right;
}